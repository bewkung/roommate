...
app.use(
  session({
    secret: "secret_key_very_secret", // เปลี่ยนเป็น key จริงๆ
    ...
    cookie: {
      ...
      maxAge: 1000 * 60 * 60 * 2, // อายุ cookie 2 ชั่วโมง
      sameSite: "lax", // ช่วยป้องกัน CSRF (ถ้า front/back อยู่โดเมนเดียวกันใช้ lax)
      secure: false, // ถ้าใช้ https จริงให้เปลี่ยนเป็น true
    },
  })
);
app.use(flash());
